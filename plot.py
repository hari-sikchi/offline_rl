...
def plot_data(data, xaxis='Epoch', value="AverageEpRet", 
 ...
 (0.09019607843137255, 0.7450980392156863, 0.8117647058823529)]
    ...
    # ## Change nan data 
    # nan_indices = np.argwhere(np.isnan(data['Epoch']))
    # for idx in nan_indices:
    #     data['Epoch'][idx] = data['Epoch'][idx-1]
    #     data['AverageEpRet'][idx] = data['AverageEpRet'][idx-1]
    #     data['AverageEpCostRet'][idx] = data['AverageEpCostRet'][idx-1]
        
        # for key,value in data.items():
        #     data[key][idx] = data[key][idx-1]
        # data[idx] = data[]
